...
public class Task1 {
    ...
    static void readAndWrite(File fileIn, File fileOut) {
        ...
        try(BufferedReader bfIn = new BufferedReader(new InputStreamReader(new FileInputStream(fileIn)));
      BufferedWriter bfOut = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(fileOut, true)))){
